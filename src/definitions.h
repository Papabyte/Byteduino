...
//device specific
	...
	#define RANDOM_REGISTER 0x3FF75144L
	#define GET_CYCLE_COUNT ESP.getCycleCount()
	#define MAX_MESSAGE_LENGTH 14800
	#define MAX_MESSAGE_COUNT 1
	#define SENT_PACKAGE_BUFFER_SIZE 5000
	#define JSON_BUFFER_SIZE_FOR_RECEIVED_PACKAGE 15000
	#define RECEIVED_PACKAGE_BUFFER_SIZE 11500
#endif
